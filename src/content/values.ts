export const values = [
  {
    ...
    body: "Every claim we make links to a live product or a measurable result. If it isn't shipped, we don't count it.",
  },
  {
    title: "Uptime is a feature",
    body: "We build for what happens after launch. Monitoring, caching, and calm operations are part of the work, not an afterthought.",
  },
  {
    title: "Security is not optional",
    body: "A SOC analyst sits on the founding team. Every product is reviewed, hardened, and audit-ready before it goes live.",
  },
  {
    title: "Plain communication",
    body: "No jargon, no vanishing acts. You get weekly demos, a staging link from week one, and direct access to the engineers.",
  },
];
